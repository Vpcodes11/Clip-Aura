...
export default function ComingSoon() {
  return (
    <div className="flex flex-col items-center justify-center h-[60vh] gap-6 text-center">
      ...
      <h1 className="text-3xl font-bold">System Calibration</h1>
      <p className="text-muted max-w-md">
        The system parameters and configuration dashboard is currently being calibrated for peak performance. 
